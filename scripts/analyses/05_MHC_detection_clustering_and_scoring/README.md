...
- `04_score_MHC_EET_credibility.py`: assigns cluster-level credibility scores to candidate MHC/EET protein families using multiheme motif content, PSORTb localization, PFAM support, heme density and metatranscriptomic expression. Clusters are classified as Tier 1 credible, Tier 2 putative or Tier 3 uncertain.
