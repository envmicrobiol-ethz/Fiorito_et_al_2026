...
- `EDFigure1D_dbRDA_BM_LM_NR.R`: generates the dbRDA of the Björsmossen, Lungsmossen and Norra Romyren spatial-profile communities using the environmental variables shared across the two peatlands.
